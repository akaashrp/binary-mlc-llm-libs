...
BINARY_DIR = "/Users/akaashrp/Documents/binary-mlc-llm-libs/web-llm-models/v0_2_80"
CONFIG_PATH = "/Users/akaashrp/Documents/hf-configs"
...
def compile(
    ...
    with LOG_PATH.open("a", encoding="utf-8") as log_file:
        ...
        if tensor_parallel_shards:
            cmd += [
                "--tensor-parallel-shards",
                str(tensor_parallel_shards),
            ]    
